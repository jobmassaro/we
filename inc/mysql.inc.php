...
define("PV" ,TABELLA_DB ."pv");
define("SCONTRINO" ,TABELLA_DB . "scontrino");
define("SCONTRINI" , TABELLA_DB ."scontrini");
...
define("CALCOLO" , TABELLA_DB."calcolo");
...
define('newgiornata', TABELLA_DB .'newgiornata', true);
define('newgiocata', TABELLA_DB .'newgiocata', true);
define('newpremi', TABELLA_DB .'newpremio', true);
define('newcredito', TABELLA_DB .'newcredito', true);
